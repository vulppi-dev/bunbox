...
export abstract class AbstractCamera extends Node3D {
   ...
   *
   */
  generateFrustum(projectionViewMatrix: Matrix, frustum: Frustum): void {
    const m = projectionViewMatrix.toArray();
  ...
  override get isDirty(): boolean {
    return super.isDirty || this.__projectionMatrix.isDirty;
  }

  override markAsClean(): this {
    super.markAsClean();
    this.__projectionMatrix.markAsClean();
    return this;
  }
