/**
 * @description https://wiki.libsdl.org/SDL3/SDL_EventType
 */
export enum SDL_EventType {
   ...
   * in a callback set with SDL_AddEventWatch().
   ...
   * time. This event must be handled in a callback set with SDL_AddEventWatch().
   ...
   * directly from event watchers for this event. data1 is 1 for live-resize expose
   * events, 0 otherwise. */
