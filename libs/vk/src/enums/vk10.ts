...
export enum VkFormat {
  ...
  // Compressed Formats - BC (Block Compression for Desktop)
  ...
  // Compressed Formats - ETC2/EAC (Mobile)
...
// MARK: Command Buffer Usage Flags
